...
| `context` | Enabled; 10% margin, 1024 summary tokens, 16384 summary bytes, one recent turn | C3.12a [CP01/CP02](c3-compaction.md) fixes exact bounds, one summary/recovery, atomic retention and privacy |
